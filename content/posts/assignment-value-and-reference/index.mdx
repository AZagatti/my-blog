...
![Value and Reference](banner.png)

---

## Tipos de dados

Quando atribuimos um valor a uma variável ele pode ser um valor primitivo ou uma
estrutura de dados.
...
Os métodos que mutam o array são: `copyWithin`, `fill`, `flat`, `pop`, `push`,
...
entendido como criar vantagens em diferentes contextos, mutando ou não suas
estruturas de dados.
