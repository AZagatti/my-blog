...
![React useCallback and useMemo](banner.png)
...
a leitura [desse outro artigo](/assignment-value-and-reference/) que comento mais sobre a atribuição por valor e
referência.
...
<iframe
  src="https://codesandbox.io/embed/usecallback-children-handler-g6f6f?expanddevtools=1&fontsize=14&hidenavigation=1&theme=dark"
...
<iframe
  src="https://codesandbox.io/embed/objective-noyce-d1eb5?expanddevtools=1&fontsize=14&hidenavigation=1&theme=dark"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
...
<iframe
  src="https://codesandbox.io/embed/primitive-vs-hooks-cchcp?expanddevtools=1&fontsize=14&hidenavigation=1&theme=dark"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
